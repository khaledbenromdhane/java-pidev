...
public class Main {
    ...
    private static final serviceformation serviceFormation = new serviceformation();
    private static final serviceevaluation serviceEvaluation = new serviceevaluation();
